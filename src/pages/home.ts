...
export const homePage = (c: Context) => {
  const content = `
    ...
    <section class="container">
      ...
      <p class="section-subtitle">Cabin Maintenance plans + quality craftsmanship for Hochatown and Southeast Oklahoma</p>
      
      <div class="grid grid-4">
        <a href="/pricing" class="card service-card" style="text-align: center; text-decoration: none; color: inherit;">
          <img src="/api/assets/icons/maintenance.png" alt="Cabin Maintenance" class="service-icon" style="width: 64px; height: 64px; margin-bottom: 1rem;">
          <h3>Cabin Maintenance</h3>
          <p style="color: #666; margin-top: 0.5rem;">Inspections, hot tubs, winterization — plans from $199/mo</p>
          <span class="learn-more" style="margin-top: 1rem;">View Plans</span>
        </a>
        ...
        <a href="/services#deck" class="card service-card" style="text-align: center; text-decoration: none; color: inherit;">
          ...
          <h3>Deck Repair</h3>
          <p style="color: #666; margin-top: 0.5rem;">Restoration, board replacement, and staining</p>
          <span class="learn-more" style="margin-top: 1rem;">Learn More</span>
        </a>
      </div>
    ...
    <!-- Vacation Rental Maintenance Pricing Section -->
    <section class="container" style="margin-top: 4rem; padding: 3rem 0; background: linear-gradient(180deg, rgba(139, 69, 19, 0.1) 0%, transparent 100%); border-radius: 20px;">
      ...
      <div class="grid grid-3" style="max-width: 1000px; margin: 2rem auto;">
        <div class="card" style="text-align: center;">
          <h3 style="color: var(--primary); font-size: 1.25rem;">Cabin Care</h3>
          <p style="font-size: 2.5rem; font-weight: bold; color: var(--secondary); margin: 0.5rem 0;">$199<span style="font-size: 1rem; color: #666;">/mo</span></p>
          <p style="color: #666; font-size: 0.9rem; margin-bottom: 0.75rem;">1 hour · Monthly inspections</p>
          <p style="color: #888; font-size: 0.85rem;">Best for 1-2 BR cabins</p>
        </div>
        <div class="card" style="text-align: center; border: 3px solid var(--secondary);">
          ...
          <h3 style="color: var(--primary); font-size: 1.25rem;">Lodge Keeper</h3>
          <p style="font-size: 2.5rem; font-weight: bold; color: var(--secondary); margin: 0.5rem 0;">$299<span style="font-size: 1rem; color: #666;">/mo</span></p>
          <p style="color: #666; font-size: 0.9rem; margin-bottom: 0.75rem;">2 hours · Bi-weekly checks</p>
          <p style="color: #888; font-size: 0.85rem;">Best for 3-4 BR lodges</p>
        </div>
        <div class="card" style="text-align: center;">
          <h3 style="color: var(--primary); font-size: 1.25rem;">Premium Care</h3>
          <p style="font-size: 2.5rem; font-weight: bold; color: var(--secondary); margin: 0.5rem 0;">$399<span style="font-size: 1rem; color: #666;">/mo</span></p>
          <p style="color: #666; font-size: 0.9rem; margin-bottom: 0.75rem;">4 hours · Full oversight</p>
          <p style="color: #888; font-size: 0.85rem;">Best for 5+ BR luxury cabins</p>
        </div>
      </div>
      
      <div style="text-align: center;">
        <a href="/pricing" class="btn btn-primary" style="font-size: 1.1rem;">View All Plans & Add-Ons →</a>
      </div>
    </section>
  ...
  `;
    ...
    description: "Vacation rental cabin maintenance & handyman services in Hochatown, Broken Bow, and SE Oklahoma. Cabin Care plans from $199/mo.",
    canonical: "/",
  }));
};
